  ...
  <header>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light white scrolling-navbar">
      <div class="container-fluid">
        ...
        <a class="navbar-brand waves-effect" href="https://mdbootstrap.com/docs/jquery/" >
          <strong class="blue-text">Internship Management System</strong>
        </a>
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <a class="logo-wrapper waves-effect">
        <img src="img/logo2.jpg" class="img-fluid" alt="" height="500" width="250">
      </a>
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="view_Application.php" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-money-bill-alt mr-3"></i>View Application</a>
      </div>
